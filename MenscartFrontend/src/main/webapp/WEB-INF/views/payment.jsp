	...
	<div class="container c1">
        ...
        <div class="col-xs-12 col-md-4">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="#"><span class="badge pull-right"><span class="fa fa-inr"></span>${subtotal}</span> Final Payment</a>
                </li>
            </ul>
            <br/>
...
document.getElementById('app').onclick = function() {myFunction()};
	function myFunction() {
