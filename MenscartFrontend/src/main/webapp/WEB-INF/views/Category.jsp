...
<body>
				...
				<div class="panel panel-info">
					...
					<div style="padding-top: 30px" class="panel-body">
						...
						<c:if test="${flag}">
							...
							<label class="col-xs-4 control-label">Category
								Id:</label>
							<div class="col-xs-8">
	...
	<div class="row col-xs-offset-1 col-xs-10 custyle">
		<table  class="table table-striped table-bordered custab">
			...
			<tbody style="color: #f90404; font-size: 15px; font-family: serif; background-color: #64f153;">
				<c:forEach items="${catdetail}" var="category" varStatus="status">
					<tr>
						...
						<td class="text-center"><a class='btn btn-warning btn-sm'
							href="getUpdateCat?catId=${category.categoryId}"><span class="glyphicon glyphicon-pencil"></span></a></td>
						<td class="text-center"><a href="deleteCategory?catId=${category.categoryId}"
