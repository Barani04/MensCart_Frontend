...
<div class="container">
	<c:if test="${flag}">
		<form action="updatepro" method="post" class="form-horizontal"
			onsubmit="return formProduct()">
	</c:if>
	<c:if test="${!flag}">
		<form action="addpro" method="post" enctype="multipart/form-data"
			class="form-horizontal" onsubmit="return formProduct()">
	</c:if>
	<div style="margin-top: 50px;" class="mainbox col-xs-6 col-xs-offset-3">
		<div class="panel panel-info">
			...
			<div style="padding-top: 30px" class="panel-body">
				...
				<div class="form-group">
					<label class="col-xs-4 control-label">Product Description:</label>
					<div class="col-xs-8">
				...
				<c:forEach items="${prodetail}" var="product" varStatus="status">
					<tr>
						...
						<td class="text-center"><a
							href="deleteProduct?proId=${product.productId}"
